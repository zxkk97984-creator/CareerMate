...
export async function GET() {
  ...
  const { profile, memories, plans, logs, simulations, updateCandidates, onboardingConversations, ...safeUser } = user;
  return ok(buildPrivacyExport({ user: safeUser, profile, memories, plans, logs, simulations, candidates: updateCandidates, onboardingConversations }));
}
