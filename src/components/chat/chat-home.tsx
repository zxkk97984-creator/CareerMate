...
export function ChatHomePage({ displayName, openChatEntry = true }: ChatHomePageProps) {
  ...
  return (
    <div className="chat-home-layout" data-testid="app-shell" data-od-id="chat-layout">
      ...
      <main
        className="chat-main"
        data-ai-source={lastAssistantMeta?.source ?? ""}
        data-ai-degraded={lastAssistantMeta?.degraded ? "1" : "0"}
        data-ai-warnings={lastAssistantWarnings.join(",")}
      >
        {/* 顶部工具条：菜单 / 会话标题 / 成长档案 */}
        <header className="chat-topbar">
          ...
          >
            ...
            <span className="profile-btn-label">成长档案</span>
